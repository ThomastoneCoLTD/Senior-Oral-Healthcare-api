    ...
    public void resetUserTestData() throws Exception {
        ...
        AdminUserDto.UserTestDataResetResponse response =
                AdminUserDto.UserTestDataResetResponse.builder()
                        ...
                        .reclaimedTokenCount(5)
                        .skippedReclaimCount(0)
                        .reclaimedAmount(5L)
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.post("/admin/user/test-data/reset")
                ...
                .andExpect(jsonPath("response.reclaimedTokenCount").value(5))
                .andExpect(jsonPath("response.skippedReclaimCount").value(0))
                .andExpect(jsonPath("response.reclaimedAmount").value(5))
